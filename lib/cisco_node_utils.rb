...
require 'cisco_node_utils/bgp'
require 'cisco_node_utils/bgp_af'
require 'cisco_node_utils/bgp_neighbor'
require 'cisco_node_utils/bgp_neighbor_af'
...
require 'cisco_node_utils/ntp_config'
require 'cisco_node_utils/ntp_server'
...
require 'cisco_node_utils/syslog_server'
require 'cisco_node_utils/syslog_settings'
