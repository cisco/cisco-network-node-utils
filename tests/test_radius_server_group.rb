...
class TestRadiusServerGroup < CiscoTestCase
  def setup
    ...
    config('radius-server host 8.8.8.8',
           ...
           'radius-server host 13.13.13.13')
    no_radiusserver
  end
  ...
  def teardown
    ...
    config('no radius-server host 8.8.8.8',
           ...
           'no radius-server host 13.13.13.13')
    no_radiusserver
    super
  end
  ...
  def test_create_destroy_single
    ...
    assert_equal(Cisco::RadiusServerGroup.radius_server_groups[id], group)
  ...
  def test_create_destroy_multiple
    ...
    assert_equal(Cisco::RadiusServerGroup.radius_server_groups[id2], group2)
